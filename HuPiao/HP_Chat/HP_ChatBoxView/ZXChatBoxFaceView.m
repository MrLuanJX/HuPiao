...
- (void) scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (page > _curPage && (page * HPScreenW - scrollView.contentOffset.x) < HPScreenW * 0.2) {
    ...
    else if (page < _curPage && (scrollView.contentOffset.x - page * HPScreenW) < HPScreenW * 0.2) {
...
- (void) pageControlClicked:(UIPageControl *)pageControl
{
    ...
    [self.scrollView scrollRectToVisible:CGRectMake(pageControl.currentPage * HPScreenW, 0, HPScreenW, self.scrollView.frameHeight) animated:YES];
...
- (void) reloadScrollView
{
    ...
    // WIDTH_SCREEN 屏幕宽
    [self.scrollView setContentSize:CGSizeMake(HPScreenW * page, self.scrollView.frameHeight)];
    [self.scrollView scrollRectToVisible:CGRectMake(0, 0, HPScreenW, self.scrollView.frameHeight) animated:NO];
    _curPage = -1;
...
- (void) showFaceFageAtIndex:(NSUInteger)index
{
    ...
    if (_curPage == -1) {
        ...
        [pageView1 setOrigin:CGPointMake(-HPScreenW, 0)];
        ...
        [pageView3 setOrigin:CGPointMake(HPScreenW, 0)];
        ...
        if (_curPage < index) {
            ...
            [pageView1 setOrigin:CGPointMake((index + 1) * HPScreenW, 0)];
            ...
            [pageView3 setOrigin:CGPointMake((index - 1) * HPScreenW, 0)];
...
{
    if (_topLine == nil) {
        _topLine = [[UIView alloc] initWithFrame:CGRectMake(0, 0, HPScreenW, 0.5)];
...
- (ZXChatFaceMenuView *) faceMenuView
{
    ...
    if (_faceMenuView == nil) {
        _faceMenuView = [[ZXChatFaceMenuView alloc] initWithFrame:CGRectMake(0, self.frameHeight - HEIGHT_BOTTOM_VIEW, HPScreenW, HEIGHT_BOTTOM_VIEW)];
