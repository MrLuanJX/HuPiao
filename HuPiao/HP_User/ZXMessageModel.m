...
-(CGSize) messageSize
{
    ...
    switch (self.messageType) {
        ...
        case ZXMessageTypeText:
            ...
            _messageSize = [label sizeThatFits:CGSizeMake(HPScreenW * 0.58, MAXFLOAT)];
            break;
        ...
        case ZXMessageTypeImage:
        {
            ...
            if (_image != nil) {
                _messageSize = (_image.size.width > HPScreenW * 0.5 ? CGSizeMake(HPScreenW * 0.5, HPScreenW * 0.5 / _image.size.width * _image.size.height) : _image.size);
