...
@implementation HP_ImagePreviewView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        // 页面控制
        _pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(0, self.height-(k_iphone_x?80:40), HPScreenW, 20)];
